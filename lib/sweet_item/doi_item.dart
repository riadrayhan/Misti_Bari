...
class Doi extends StatefulWidget {
  const Doi({super.key});

  @override
  State<Doi> createState() => _DoiState();
}

class _DoiState extends State<Doi> {

  List<dynamic> posts = [];

  Future<void> downloadJson() async {
    final api =
        "https://raw.githubusercontent.com/riadrayhan/Misti_Bari/main/doi";
